...
while (my $line = <$in1>) { chomp($line);
	...
	my ($bc, $bcs, $seq2, $qua2, $bc3);
#	return ($barcode, $barcode2, $bc0, $seq, $qua, $data, $barcode3);

	($bc, $bcs, $bc0, $seq2, $qua2, $data, $bc3, $bc02) = infer_barcode($bc0, $seq, $qua, $readName, $data, $bc02);
	...
	print $outExtra "$readName\t$bc\t$bc3\n";

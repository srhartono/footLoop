...
use warnings; use strict; use Getopt::Std; use foot; require footz2; use FAlite;
...
(NOT IMPLEMENTED) -H: Run HMM peak caller
...
__END__
	#defined($opt_c) ? "c(-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 9.5" : "c(-0.5, 0.5, 1.5, 2.5, 6.5, 9.5";
	#$breaks .= ", 10.5, 11.5, 12.5, 13.5)";

   my $colors = defined($opt_c) ? "c(\"cornsilk\",\"green4\",\"white\",\"cornsilk\",\"green4\",\"purple\",\"grey\",\"red4\")" : "c(\"cornsilk\",\"green4\",\"white\",\"grey\",\"red4\")";
   #my $colors = defined($opt_c) ? "c(\"cornsilk\",\"red4\",\"white\",\"cornsilk\",\"green4\",\"purple\",\"grey\",\"green4\")" : "c(\"cornsilk\",\"green4\",\"white\",\"grey\",\"red4\")";

		#$nuc = $nuc =~ /A/i ? 3 : "seagreen4" : $nuc =~ /C/i ? "blue4" : $nuc =~ /G/i ? "saddlebrown" : $nuc =~ /T/i ? "red4" : "grey";
					} else {
						heatmap.3(
							x=df,
							dendrogram=\"none\",

...
print "\nDone recording to footPeak logFile PARAMS ($opts->{o}/footPeak_logFile_PARAMS.txt)\n";
#open ($outLog, ">", "$defOpts->{o}/footPeak_logFile_PARAMS.txt") or print "Failed to write to $defOpts->{o}/footPeak_logFile.txt: $!\n" and die;


die "

$YW-------------------------------------$N
$LGN     footPeak_fix_Params Done!$N
$YW-------------------------------------$N
